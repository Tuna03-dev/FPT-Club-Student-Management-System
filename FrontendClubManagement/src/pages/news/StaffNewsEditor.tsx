...
export default function StaffNewsEditor() {
  ...
  const [thumbnailUrl, setThumbnailUrl] = useState<string>(""); // URL thật gửi BE
  const [thumbPreview, setThumbPreview] = useState<string>(""); // DataURL preview
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <div className="space-y-2">
        ...
        <input
          className={`w-full border rounded-lg p-3 focus:outline-none focus:ring-2 ${
            errors.title ? "border-rose-500 focus:ring-rose-200" : "border-slate-300 focus:ring-blue-500"
          }`}
        ...
        >
          <SelectTrigger
            className={`w-full px-3 py-2 rounded-lg border ${
              errors.newsType ? "border-rose-500 focus:ring-rose-200" : "border-slate-300 focus:ring-blue-500"
            }`}
          >
      ...
      <div className="space-y-2">
        ...
        <textarea
          className={`w-full border rounded-lg p-3 min-h-[280px] focus:outline-none focus:ring-2 ${
            errors.content ? "border-rose-500 focus:ring-rose-200" : "border-slate-300 focus:ring-blue-500"
          }`}
      ...
      <div className="flex gap-3 pt-6 border-t">
        <button
          ...
          disabled={saving}
        >
          {saving ? <Loader2 className="h-4 w-4 animate-spin inline-block mr-2" /> : null}
...
/** Drop-zone preview bằng DataURL, thêm errorMsg để viền/ nền đỏ khi lỗi */
