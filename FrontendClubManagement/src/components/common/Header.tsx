      ...
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between py-4">
          <Link to="/" className="flex items-center gap-3">
            <img src="/public/Logo_Trường_Đại_học_FPT.svg" alt="FPT" className="h-10" />
            <div className="hidden sm:block">
              <div className="text-sm font-semibold text-orange-600">TỔ CHỨC GIÁO DỤC FPT</div>
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <Link to="/clubs" className="text-gray-700 hover:text-orange-600 font-medium">
              Câu lạc bộ
            </Link>
            <Link to="/events" className="text-gray-700 hover:text-orange-600 font-medium">
              Sự kiện
            </Link>
            <Link to="/news" className="text-gray-700 hover:text-orange-600 font-medium">
              Tin tức
            </Link>
