...
public enum ErrorCode {
    ...
    ORG_UNAUTHORIZED(HttpStatus.FORBIDDEN, 403, "Tài khoản của bạn không thuộc tổ chức của chúng tôi"),
    CLUB_NOT_FOUND(HttpStatus.NOT_FOUND, 2000, "Không tìm thấy câu lạc bộ"),
    CLUB_NOT_ACTIVE(HttpStatus.FORBIDDEN, 2005, "Chỉ câu lạc bộ đang hoạt động (status = ACTIVE) mới có thể thực hiện thao tác này"),
    NOT_FOUND(HttpStatus.NOT_FOUND,404, "Không tìm thấy tài nguyên"),
    ROLE_NOT_FOUND(HttpStatus.NOT_FOUND, 2001, "Không tìm thấy vai trò"),
    MEMBER_NOT_FOUND(HttpStatus.NOT_FOUND, 2002, "Không tìm thấy thành viên"),
    USER_NOT_FOUND(HttpStatus.NOT_FOUND, 2003, "Không tìm thấy người dùng"),
    USER_NOT_ACTIVE(HttpStatus.UNAUTHORIZED, 401, "Tài khoản không được kích hoạt"),
    SEMESTER_NOT_FOUND(HttpStatus.NOT_FOUND, 2004, "Không tìm thấy kỳ học"),
    UNAUTHENTICATED(HttpStatus.UNAUTHORIZED, 401, "Người dùng chưa xác thực"),
    ...
    POST_NOT_FOUND (HttpStatus.NOT_FOUND, 2001, "Không tìm thấy bài viết"),
    ...
    TEAM_NOT_FOUND(HttpStatus.NOT_FOUND, 8004, "Không tìm thấy ban/đội"),
