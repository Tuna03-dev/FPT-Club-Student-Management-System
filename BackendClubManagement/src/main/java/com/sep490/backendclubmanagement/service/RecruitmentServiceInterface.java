...
public interface RecruitmentServiceInterface {
    ...
    RecruitmentApplicationData submitApplication(Long applicantId, ApplicationSubmitRequest request, MultiValueMap<String, MultipartFile> allFiles) throws AppException;
